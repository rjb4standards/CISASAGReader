...
Here is a simple windows batch file to process all SAG Spreadsheets in a folder (also downloadble here https://github.com/rjb4standards/CISASAGReader/blob/main/cisasagassess.bat) 
```sh
